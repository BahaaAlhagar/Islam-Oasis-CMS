...
var manageRecitations = new Vue({
  ...
  methods: {
    ...
    afterRecitationDeleted: function afterRecitationDeleted(response) {
  ...
  components: {
    recitationsTable: __WEBPACK_IMPORTED_MODULE_0__components_recitations_recitationsTable___default.a,
...
Component.options.__file = "resources\\assets\\js\\admin\\components\\recitations\\recitationsTable.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6d4742bc", Component.options)
  } else {
    hotAPI.reload("data-v-6d4742bc", Component.options)
' + '  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__addRecitation__ = __webpack_require__(95);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__addRecitationTranslation__ = __webpack_require__(98);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__editRecitationTranslation__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__editRecitationTranslation___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__editRecitationTranslation__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        ...
        editRecitationTranslation: __WEBPACK_IMPORTED_MODULE_2__editRecitationTranslation___default.a
    }
});
...
Component.options.__file = "resources\\assets\\js\\admin\\components\\recitations\\editRecitationTranslation.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-54c70730", Component.options)
  } else {
    hotAPI.reload("data-v-54c70730", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        onTranslationCreate: function onTranslationCreate() {
            this.editRecitationTranslationForm.patch(window.location.pathname + '/' + this.recitation).then(function (response) {
                return eventBus.$emit('recitationAdded', response);
            });
        },
    ...
    mounted: function mounted() {
        ...
        eventBus.$on('editRecitationTranslation', function (translation) {
            ...
            _c(
              "form",
              {
                ...
                on: {
                  ...
                  keydown: function($event) {
                    _vm.editRecitationTranslationForm.errors.clear(
                      $event.target.name
                    )
                  },
                  change: function($event) {
              ...
              [
                _c("div", { staticClass: "form-group" }, [
                    ...
                    "select",
                    {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.editRecitationTranslationForm.locale,
                          expression: "editRecitationTranslationForm.locale"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { id: "locale", name: "locale", disabled: "" },
                      on: {
                        change: function($event) {
                          ...
                          _vm.$set(
                            _vm.editRecitationTranslationForm,
                            "locale",
                            $event.target.multiple
                              ? $$selectedVal
                              : $$selectedVal[0]
                  ...
                  _vm._v(" "),
                  _vm.editRecitationTranslationForm.errors.has("locale")
                    ? _c("span", {
                        staticClass: "alert-danger",
                        domProps: {
                          textContent: _vm._s(
                            _vm.editRecitationTranslationForm.errors.get(
                              "locale"
                            )
                          )
                        }
                ...
                _c("div", { staticClass: "form-group" }, [
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.editRecitationTranslationForm.name,
                        expression: "editRecitationTranslationForm.name"
                      }
                    ],
                    staticClass: "form-control",
                    attrs: { type: "text", id: "name", name: "name" },
                    domProps: { value: _vm.editRecitationTranslationForm.name },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                  ...
                  _vm._v(" "),
                  _vm.editRecitationTranslationForm.errors.has("name")
                    ? _c("span", {
                        staticClass: "alert-danger",
                        domProps: {
                          textContent: _vm._s(
                            _vm.editRecitationTranslationForm.errors.get("name")
                          )
                        }
                      })
                    : _vm._e()
                ...
                _c("div", { staticClass: "form-group text-center" }, [
                  _c(
                    "button",
                    {
                      ...
                      attrs: {
                        disabled: _vm.editRecitationTranslationForm.errors.any()
                      }
                    },
                    [_vm._v("تعديل")]
                  )
    ...
    return _c("div", { staticClass: "modal-header" }, [
      ...
      _c("span", { staticClass: "form-control-static text-center" }, [
        _c(
          "h4",
          { staticClass: "modal-title", attrs: { id: "myModalLabel" } },
          [_vm._v(" تعديل ترجمة لرواية او قراءة ")]
        )
      ])
    ])
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-54c70730", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("edit-recitation-translation", { attrs: { locales: _vm.locales } })
    ],
    1
  )
}
