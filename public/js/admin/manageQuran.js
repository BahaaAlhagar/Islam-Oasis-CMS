...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_quran_quranTable__ = __webpack_require__(125);
                ...
                _c(
                  ...
                  [
                    ...
                    _c("v-select", {
                      ...
                      on: {
                        input: function($event) {
                          _vm.form.errors.clear("scholar_id")
                        }
                      },
                      model: {
                ...
                _c(
                  ...
                  [
                    ...
                    _c("v-select", {
                      ...
                      on: {
                        input: function($event) {
                          _vm.form.errors.clear("recitation_id")
                        }
                      },
                      model: {
                ...
                _c(
                  ...
                  [
                    ...
                    _c("v-select", {
                      ...
                      on: {
                        input: function($event) {
                          _vm.editForm.errors.clear("scholar_id")
                        }
                      },
                      model: {
                        value: _vm.editForm.scholar,
                        callback: function($$v) {
                          _vm.$set(_vm.editForm, "scholar", $$v)
                        },
                        expression: "editForm.scholar"
                      }
                    }),
                    _vm._v(" "),
                ...
                _c(
                  ...
                  [
                    ...
                    _c("v-select", {
                      ...
                      on: {
                        input: function($event) {
                          _vm.editForm.errors.clear("recitation_id")
                        }
                      },
                      model: {
                        value: _vm.editForm.recitation,
                        callback: function($$v) {
                          _vm.$set(_vm.editForm, "recitation", $$v)
                        },
                        expression: "editForm.recitation"
                      }
                    }),
                    _vm._v(" "),
