...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_quran_quranTable__ = __webpack_require__(127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_quran_quranTable___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_quran_quranTable__);
...
var manageQuran = new Vue({
  ...
  methods: {
    ...
    afterQuranAdded: function afterQuranAdded(response) {
      $('.modal.in').modal('hide');
      toastr.success(response.message);
      this.reloadData();
    },
    afterQuranDelete: function afterQuranDelete(response) {
  ...
  components: {
    quranTable: __WEBPACK_IMPORTED_MODULE_1__components_quran_quranTable___default.a,
  ...
  mounted: function mounted() {
    ...
    eventBus.$on('quranAdded', function (response) {
      return _this2.afterQuranAdded(response);
    });
    eventBus.$on('quranDeleted', function (response) {
      return _this2.afterQuranDelete(response);
    });
  }
});
...
Component.options.__file = "resources\\assets\\js\\admin\\components\\quran\\quranTable.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1c4cebc4", Component.options)
  } else {
    hotAPI.reload("data-v-1c4cebc4", Component.options)
' + '  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__addQuran__ = __webpack_require__(129);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        editQuran: function editQuran(quran) {
    ...
    components: {
        addQuran: __WEBPACK_IMPORTED_MODULE_0__addQuran___default.a,
        editQuran: __WEBPACK_IMPORTED_MODULE_1__editQuran___default.a
    }
});
...
Component.options.__file = "resources\\assets\\js\\admin\\components\\quran\\addQuran.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-619a11a5", Component.options)
  } else {
    hotAPI.reload("data-v-619a11a5", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        onQuranCreate: function onQuranCreate() {
        ...
        getScholars: __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.debounce(function (search, loading, vm) {
            axios.get('/admincp/search/scholars/' + search).then(function (resp) {
                vm.scholars = resp.data;
                loading(false);
            });
        }, 1000),
        searchRecitations: function searchRecitations(search, loading) {
            loading(true);
            this.getRecitations(search, loading, this);
        },

        getRecitations: __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.debounce(function (search, loading, vm) {
            axios.get('/admincp/search/recitations/' + search).then(function (resp) {
    ...
    watch: {
        'form.notFilteredScholar': function formNotFilteredScholar(val) {
            val ? this.form.scholar_id = val.id : this.form.scholar_id = '';
        },
        'form.notFilteredRecitation': function formNotFilteredRecitation(val) {
              ...
              [
                _vm._l(_vm.locales, function(locale, key) {
                  return _c("div", { staticClass: "form-group" }, [
                    _c(
                      "label",
                      { staticClass: "label", attrs: { for: "name[key]" } },
                      [_vm._v("الاسم بـ " + _vm._s(locale.native) + ":")]
                    ),
                    _vm._v(" "),
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.form.name[key],
                          expression: "form.name[key]"
                        }
                      ],
                ...
                _c(
                  ...
                  [
                    _c(
                      "label",
                      { staticClass: "label", attrs: { for: "scholar_id" } },
                      [_vm._v("القارئ:")]
                    ),
                    _vm._v(" "),
                    _c("v-select", {
                      ...
                      model: {
                        value: _vm.form.notFilteredScholar,
                        callback: function($$v) {
                          _vm.$set(_vm.form, "notFilteredScholar", $$v)
                        },
                        expression: "form.notFilteredScholar"
                      }
                    }),
                    _vm._v(" "),
                    _vm.form.errors.has("scholar_id")
                      ? _c("span", {
                          staticClass: "alert-danger",
                          domProps: {
                            textContent: _vm._s(
                              _vm.form.errors.get("scholar_id")
                            )
                          }
                        })
                      : _vm._e()
                ...
                _c(
                  ...
                  [
                    _c(
                      "label",
                      { staticClass: "label", attrs: { for: "recitation_id" } },
                      [_vm._v("التلاوة:")]
                    ),
                    _vm._v(" "),
                    _c("v-select", {
                      attrs: {
                        label: "name",
                        "on-search": _vm.searchRecitations,
                        options: _vm.recitations,
                        placeholder: "اكتب اسم للبحث",
                        id: "recitation_id",
                        name: "recitation_id"
                      },
                      model: {
                        value: _vm.form.notFilteredRecitation,
                        callback: function($$v) {
                          _vm.$set(_vm.form, "notFilteredRecitation", $$v)
                        },
                        expression: "form.notFilteredRecitation"
                      }
                    }),
                    _vm._v(" "),
                    _vm.form.errors.has("recitation_id")
                      ? _c("span", {
                          staticClass: "alert-danger",
                          domProps: {
                            textContent: _vm._s(
                              _vm.form.errors.get("recitation_id")
                            )
                          }
                        })
                      : _vm._e()
                ...
                _c("div", { staticClass: "form-group" }, [
                  ...
                  _vm._v(" "),
                  _vm.form.errors.has("url")
                    ? _c("span", {
                        staticClass: "alert-danger",
                        domProps: {
                          textContent: _vm._s(_vm.form.errors.get("url"))
                        }
                      })
                    : _vm._e()
                ]),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-619a11a5", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\admin\\components\\quran\\editQuran.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ae8b9154", Component.options)
  } else {
    hotAPI.reload("data-v-ae8b9154", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        onQuranUpdate: function onQuranUpdate() {
            this.editForm.patch('/admincp/quran/' + this.quran_id).then(function (response) {
                return eventBus.$emit('quranAdded', response);
            });
        },
    ...
    watch: {
        'editForm.notFilteredScholar': function editFormNotFilteredScholar(val) {
            val ? this.editForm.scholar_id = val.id : this.editForm.scholar_id = '';
        },
        'editForm.notFilteredRecitation': function editFormNotFilteredRecitation(val) {
    ...
    mounted: function mounted() {
        ...
        eventBus.$on('editQuran', function (quran) {
            return _this.editQuranModal(quran);
        });
    }
});
              ...
              [
                _vm._l(_vm.locales, function(locale, key) {
                  return _c("div", { staticClass: "form-group" }, [
                    ...
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.editForm.name[key],
                          expression: "editForm.name[key]"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: {
                      ...
                      domProps: { value: _vm.editForm.name[key] },
                      on: {
                        input: [
                          function($event) {
                            if ($event.target.composing) {
                          ...
                          function($event) {
                            _vm.editForm.errors.clear(_vm.nameKey(key))
                          }
                        ]
                      }
                    }),
                    _vm._v(" "),
                    _vm.editForm.errors.has(_vm.nameKey(key))
                      ? _c("span", {
                          staticClass: "alert-danger",
                          domProps: {
                            textContent: _vm._s(
                              _vm.editForm.errors.get(_vm.nameKey(key))
                            )
                          }
                        })
                      : _vm._e()
                ...
                _c(
                  ...
                  [
                    ...
                    _c("v-select", {
                      ...
                      model: {
                        value: _vm.editForm.notFilteredScholar,
                        callback: function($$v) {
                          _vm.$set(_vm.editForm, "notFilteredScholar", $$v)
                        },
                        expression: "editForm.notFilteredScholar"
                      }
                    }),
                    _vm._v(" "),
                    _vm.editForm.errors.has("scholar_id")
                      ? _c("span", {
                          staticClass: "alert-danger",
                          domProps: {
                            textContent: _vm._s(
                              _vm.editForm.errors.get("scholar_id")
                            )
                          }
                        })
                      : _vm._e()
                ...
                _c(
                  ...
                  [
                    ...
                    _c("v-select", {
                      ...
                      model: {
                        value: _vm.editForm.notFilteredRecitation,
                        callback: function($$v) {
                          _vm.$set(_vm.editForm, "notFilteredRecitation", $$v)
                        },
                        expression: "editForm.notFilteredRecitation"
                      }
                    }),
                    _vm._v(" "),
                    _vm.editForm.errors.has("recitation_id")
                      ? _c("span", {
                          staticClass: "alert-danger",
                          domProps: {
                            textContent: _vm._s(
                              _vm.editForm.errors.get("recitation_id")
                            )
                          }
                        })
                      : _vm._e()
                ...
                _c("div", { staticClass: "form-group" }, [
                  ...
                  _c("input", {
                    ...
                    staticClass: "form-control",
                    attrs: { type: "text", id: "url", name: "url" },
                    domProps: { value: _vm.editForm.url },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.editForm, "url", $event.target.value)
                      }
                    }
                  }),
                  _vm._v(" "),
                  _vm.editForm.errors.has("url")
                    ? _c("span", {
                        staticClass: "alert-danger",
                        domProps: {
                          textContent: _vm._s(_vm.editForm.errors.get("url"))
                        }
                      })
                    : _vm._e()
                ]),
  ...
  return _c(
    ...
    [
      _vm.qurans.length
        ...
        : _vm._e(),
      _vm._v(" "),
      _c("add-quran", { attrs: { locales: _vm.locales } }),
      _vm._v(" "),
      _c("edit-quran", { attrs: { locales: _vm.locales } })
    ],
    1
  )
}
