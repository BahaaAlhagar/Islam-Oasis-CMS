...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_scholars_scholarsTable__ = __webpack_require__(98);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__partials_DataForm__ = __webpack_require__(113);
...
var manageScholars = new Vue({
  ...
  components: {
    scholarsTable: __WEBPACK_IMPORTED_MODULE_0__components_scholars_scholarsTable___default.a,
...
Component.options.__file = "resources\\assets\\js\\admin\\components\\scholars\\scholarsTable.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-511587bc", Component.options)
  } else {
    hotAPI.reload("data-v-511587bc", Component.options)
' + '  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__addScholar__ = __webpack_require__(100);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__addScholarTranslation__ = __webpack_require__(103);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__editScholarTranslation__ = __webpack_require__(106);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__imageUploader__ = __webpack_require__(109);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        localeCheck: function localeCheck(key, scholar) {
            var trans = scholar.translations;
        ...
        addTranslation: function addTranslation(scholar, key) {
        ...
        deleteTranslation: function deleteTranslation(translation) {
            if (confirm('هل انت متأكد من حذف هذه الترجمة؟')) {
                axios.delete('/admincp/scholartranslation/' + translation.id).then(function (response) {
        ...
        changeImage: function changeImage(scholar) {
...
Component.options.__file = "resources\\assets\\js\\admin\\components\\scholars\\addScholarTranslation.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4c93ffb2", Component.options)
  } else {
    hotAPI.reload("data-v-4c93ffb2", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        onTranslationCreate: function onTranslationCreate() {
            this.addScholarTranslationForm.post(window.location.pathname + '/' + this.scholar).then(function (response) {
                return eventBus.$emit('scholarAdded', response);
            });
        },
        prepareModal: function prepareModal(scholar, key) {
            ...
            _c(
              "form",
              {
                ...
                on: {
                  ...
                  keydown: function($event) {
                    _vm.addScholarTranslationForm.errors.clear(
                      $event.target.name
                    )
                  },
                  change: function($event) {
              ...
              [
                _c("div", { staticClass: "form-group" }, [
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.addScholarTranslationForm.locale,
                          expression: "addScholarTranslationForm.locale"
                        }
                      ],
                      staticClass: "form-control",
                  ...
                  _vm._v(" "),
                  _vm.addScholarTranslationForm.errors.has("locale")
                    ? _c("span", {
                        staticClass: "alert-danger",
                        domProps: {
                          textContent: _vm._s(
                            _vm.addScholarTranslationForm.errors.get("locale")
                          )
                        }
                      })
                    : _vm._e()
                ...
                _c("div", { staticClass: "form-group" }, [
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.addScholarTranslationForm.name,
                        expression: "addScholarTranslationForm.name"
                      }
                    ],
                    staticClass: "form-control",
                    attrs: { type: "text", id: "name", name: "name" },
                    domProps: { value: _vm.addScholarTranslationForm.name },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                  ...
                  _vm._v(" "),
                  _vm.addScholarTranslationForm.errors.has("name")
                    ? _c("span", {
                        staticClass: "alert-danger",
                        domProps: {
                          textContent: _vm._s(
                            _vm.addScholarTranslationForm.errors.get("name")
                          )
                        }
                      })
                    : _vm._e()
                ...
                _c("div", { staticClass: "form-group" }, [
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.addScholarTranslationForm.biography,
                        expression: "addScholarTranslationForm.biography"
                      }
                    ],
                    staticClass: "form-control",
                    attrs: {
                  ...
                  _vm._v(" "),
                  _vm.addScholarTranslationForm.errors.has("biography")
                    ? _c("span", {
                        staticClass: "alert-danger",
                        domProps: {
                          textContent: _vm._s(
                            _vm.addScholarTranslationForm.errors.get(
                              "biography"
                            )
                          )
                        }
                ...
                _c("div", { staticClass: "form-group" }, [
                  ...
                  _c("input", {
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model.number",
                        value: _vm.addScholarTranslationForm.published,
                        expression: "addScholarTranslationForm.published",
                        modifiers: { number: true }
                      }
                    ],
                    attrs: { type: "radio", id: "published", value: "1" },
                    domProps: {
                      checked: _vm._q(
                        _vm.addScholarTranslationForm.published,
                        _vm._n("1")
                      )
                    },
                    on: {
                  ...
                  _c("br"),
                  _vm._v(" "),
                  _vm.addScholarTranslationForm.errors.has("published")
                    ? _c("span", {
                        staticClass: "alert-danger",
                        domProps: {
                          textContent: _vm._s(
                ...
                _c("div", { staticClass: "form-group text-center" }, [
                  _c(
                    "button",
                    {
                      staticClass: "button btn-lg btn-success",
                      attrs: {
                        disabled: _vm.addScholarTranslationForm.errors.any()
                      }
                    },
                    [_vm._v("اضافة")]
                  )
    ...
    return _c("div", { staticClass: "modal-header" }, [
      ...
      _c("span", { staticClass: "form-control-static text-center" }, [
        _c(
          "h4",
          { staticClass: "modal-title", attrs: { id: "myModalLabel" } },
          [_vm._v(" اضافة ترجمة لعالم او قارئ ")]
        )
      ])
    ])
  },
...
Component.options.__file = "resources\\assets\\js\\admin\\components\\scholars\\imageUploader.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-836751b8", Component.options)
  } else {
    hotAPI.reload("data-v-836751b8", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        eventBus.$on('imageUploader', function (scholar) {
            return _this2.imageUploaderModal(scholar);
        });
    }
});
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-836751b8", module.exports)
  }
}
