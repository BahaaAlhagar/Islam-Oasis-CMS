...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_fatwas_fatwasTable__ = __webpack_require__(178);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_fatwas_fatwasTable___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_fatwas_fatwasTable__);
...
var manageFatwas = new Vue({
  ...
  methods: {
    ...
    afterFatwaCreated: function afterFatwaCreated(response) {
      $('.modal.in').modal('hide');
      toastr.success(response.message);
      this.reloadData();
    },
    afterFatwaDelete: function afterFatwaDelete(response) {
      toastr.warning(response.data.message);
      this.reloadData();
    },
    addFatwa: function addFatwa() {
      eventBus.$emit('addFatwa');
    }
  },
  components: {
    fatwasTable: __WEBPACK_IMPORTED_MODULE_0__components_fatwas_fatwasTable___default.a,
  ...
  mounted: function mounted() {
    ...
    eventBus.$on('fatwaAdded', function (response) {
      return _this2.afterFatwaCreated(response);
    });
    eventBus.$on('fatwaDeleted', function (response) {
      return _this2.afterFatwaDelete(response);
    });
  }
});
...
Component.options.__file = "resources\\assets\\js\\admin\\components\\fatwas\\fatwasTable.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0681925c", Component.options)
  } else {
    hotAPI.reload("data-v-0681925c", Component.options)
' + '  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__addFatwa__ = __webpack_require__(180);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__addFatwaTranslation__ = __webpack_require__(183);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__editFatwa__ = __webpack_require__(186);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        localeCheck: function localeCheck(key, fatwa) {
            var trans = fatwa.translations;
        ...
        addTranslation: function addTranslation(fatwa, key) {
            eventBus.$emit('addFatwaTranslation', fatwa, key);
        },
        editFatwa: function editFatwa(fatwa, translation) {
        ...
        deleteTranslation: function deleteTranslation(translation) {
            if (confirm('هل انت متأكد من حذف هذه الترجمة؟')) {
                axios.delete('/admincp/fatwatranslation/' + translation.id).then(function (response) {
                    return eventBus.$emit('fatwaDeleted', response);
                });
            }
        },
        deleteFatwa: function deleteFatwa(fatwa) {
            if (confirm('هل انت متأكد من حذف هذا المحتوى بترجماته؟')) {
                axios.delete('/admincp/fatwas/' + fatwa.id).then(function (response) {
                    return eventBus.$emit('fatwaDeleted', response);
                });
            }
        }
...
Component.options.__file = "resources\\assets\\js\\admin\\components\\fatwas\\addFatwa.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-bdfe7ed8", Component.options)
  } else {
    hotAPI.reload("data-v-bdfe7ed8", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_trumbowyg__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_trumbowyg_dist_ui_trumbowyg_css__ = __webpack_require__(27);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        onFatwaCreate: function onFatwaCreate() {
            this.addFatwaForm.post('/admincp/fatwas').then(function (response) {
                return eventBus.$emit('fatwaAdded', response);
            });
        },
        addFatwaModal: function addFatwaModal() {
    ...
    mounted: function mounted() {
        ...
        eventBus.$on('addFatwa', function (event) {
            return _this.addFatwaModal();
        });
    }
});
              ...
              _c(
                "form",
                {
                  ...
                  on: {
                    submit: function($event) {
                      ...
                      _vm.onFatwaCreate($event)
                    },
                    keydown: function($event) {
                      _vm.addFatwaForm.errors.clear($event.target.name)
                    },
                ...
                [
                  _c("div", { staticClass: "form-group" }, [
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.addFatwaForm.locale,
                            expression: "addFatwaForm.locale"
                          }
                        ],
                    ...
                    _vm._v(" "),
                    _vm.addFatwaForm.errors.has("locale")
                      ? _c("span", {
                          staticClass: "alert-danger",
                          domProps: {
                            textContent: _vm._s(
                              _vm.addFatwaForm.errors.get("locale")
                            )
                          }
                        })
                      : _vm._e()
                  ...
                  _c("div", { staticClass: "form-group" }, [
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.addFatwaForm.question,
                          expression: "addFatwaForm.question"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text", id: "question", name: "question" },
                      domProps: { value: _vm.addFatwaForm.question },
                      on: {
                        input: function($event) {
                    ...
                    _vm._v(" "),
                    _vm.addFatwaForm.errors.has("question")
                      ? _c("span", {
                          staticClass: "alert-danger",
                          domProps: {
                            textContent: _vm._s(
                              _vm.addFatwaForm.errors.get("question")
                            )
                          }
                        })
                      : _vm._e()
                  ...
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _c("trumbowyg", {
                        attrs: { name: "addFatwaForm.answer" },
                        model: {
                          value: _vm.addFatwaForm.answer,
                          callback: function($$v) {
                            _vm.$set(_vm.addFatwaForm, "answer", $$v)
                          },
                          expression: "addFatwaForm.answer"
                        }
                      }),
                      _vm._v(" "),
                      _vm.addFatwaForm.errors.has("answer")
                        ? _c("span", {
                            staticClass: "alert-danger",
                            domProps: {
                              textContent: _vm._s(
                                _vm.addFatwaForm.errors.get("answer")
                              )
                            }
                          })
                        : _vm._e()
                  ...
                  _vm.type == 1
                    ? _c(
                        ...
                        [
                          ...
                          _vm._v(" "),
                          _vm.addFatwaForm.errors.has("scholar_id")
                            ? _c("span", {
                                staticClass: "alert-danger",
                                domProps: {
                                  textContent: _vm._s(
                                    _vm.addFatwaForm.errors.get("scholar_id")
                                  )
                                }
                              })
                            : _vm._e()
                  ...
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _vm.addFatwaForm.errors.has("tags")
                        ? _c("span", {
                            staticClass: "alert-danger",
                            domProps: {
                              textContent: _vm._s(
                                _vm.addFatwaForm.errors.get("tags")
                              )
                            }
                          })
                        : _vm._e()
                  ...
                  _c("div", { staticClass: "form-group text-center" }, [
                    _c(
                      "button",
                      {
                        ...
                        attrs: { disabled: _vm.addFatwaForm.errors.any() }
                      },
                      [_vm._v("اضافة")]
                    )
                  ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-bdfe7ed8", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\admin\\components\\fatwas\\addFatwaTranslation.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f0f98da6", Component.options)
  } else {
    hotAPI.reload("data-v-f0f98da6", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        onPostCreate: function onPostCreate() {
            this.addTranslationForm.post('/admincp/fatwas/' + this.fatwa_id).then(function (response) {
                return eventBus.$emit('fatwaAdded', response);
            });
        },
        addFatwaTranslationModal: function addFatwaTranslationModal(fatwa, key) {
    ...
    watch: {
        "addTranslationForm.notFilteredTags": function addTranslationFormNotFilteredTags(val) {
        ...
        "addTranslationForm.notFilteredScholar": function addTranslationFormNotFilteredScholar(val) {
    ...
    mounted: function mounted() {
        ...
        eventBus.$on('addFatwaTranslation', function (fatwa, key) {
            return _this.addFatwaTranslationModal(fatwa, key);
        });
    }
});
              ...
              _c(
                "form",
                {
                  ...
                  on: {
                    ...
                    keydown: function($event) {
                      _vm.addTranslationForm.errors.clear($event.target.name)
                    },
                    change: function($event) {
                      _vm.addTranslationForm.errors.clear($event.target.name)
                    },
                ...
                [
                  _c("div", { staticClass: "form-group" }, [
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.addTranslationForm.locale,
                            expression: "addTranslationForm.locale"
                          }
                        ],
                        staticClass: "form-control",
                    ...
                    _vm._v(" "),
                    _vm.addTranslationForm.errors.has("locale")
                      ? _c("span", {
                          staticClass: "alert-danger",
                          domProps: {
                            textContent: _vm._s(
                              _vm.addTranslationForm.errors.get("locale")
                            )
                          }
                        })
                      : _vm._e()
                  ...
                  _c("div", { staticClass: "form-group" }, [
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.addTranslationForm.question,
                          expression: "addTranslationForm.question"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text", id: "question", name: "question" },
                      domProps: { value: _vm.addTranslationForm.question },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                    ...
                    _vm._v(" "),
                    _vm.addTranslationForm.errors.has("question")
                      ? _c("span", {
                          staticClass: "alert-danger",
                          domProps: {
                            textContent: _vm._s(
                              _vm.addTranslationForm.errors.get("question")
                            )
                          }
                        })
                      : _vm._e()
                  ...
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _c("trumbowyg", {
                        attrs: { name: "addTranslationForm.answer" },
                        model: {
                          value: _vm.addTranslationForm.answer,
                          callback: function($$v) {
                            _vm.$set(_vm.addTranslationForm, "answer", $$v)
                          },
                          expression: "addTranslationForm.answer"
                        }
                      }),
                      _vm._v(" "),
                      _vm.addTranslationForm.errors.has("answer")
                        ? _c("span", {
                            staticClass: "alert-danger",
                            domProps: {
                              textContent: _vm._s(
                                _vm.addTranslationForm.errors.get("answer")
                              )
                            }
                          })
                        : _vm._e()
                    ...
                    ? _c(
                        ...
                        [
                          ...
                          _c("v-select", {
                            ...
                            model: {
                              value: _vm.addTranslationForm.notFilteredScholar,
                              callback: function($$v) {
                                _vm.$set(
                                  _vm.addTranslationForm,
                                  "notFilteredScholar",
                              ...
                              expression:
                                "addTranslationForm.notFilteredScholar"
                            }
                          }),
                          _vm._v(" "),
                          _vm.addTranslationForm.errors.has("scholar_id")
                            ? _c("span", {
                                staticClass: "alert-danger",
                                domProps: {
                                  textContent: _vm._s(
                                    _vm.addTranslationForm.errors.get(
                                      "scholar_id"
                                    )
                                  )
                                }
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c("v-select", {
                        ...
                        model: {
                          value: _vm.addTranslationForm.notFilteredTags,
                          callback: function($$v) {
                            _vm.$set(
                              _vm.addTranslationForm,
                              "notFilteredTags",
                          ...
                          expression: "addTranslationForm.notFilteredTags"
                        }
                      }),
                      _vm._v(" "),
                      _vm.addTranslationForm.errors.has("tags")
                        ? _c("span", {
                            staticClass: "alert-danger",
                            domProps: {
                              textContent: _vm._s(
                                _vm.addTranslationForm.errors.get("tags")
                              )
                            }
                          })
                        : _vm._e()
                  ...
                  _c("div", { staticClass: "form-group text-center" }, [
                    _c(
                      ...
                      {
                        staticClass: "button btn-lg btn-success",
                        attrs: { disabled: _vm.addTranslationForm.errors.any() }
                      },
                      [_vm._v("اضافة ترجمة")]
                    )
                  ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-f0f98da6", module.exports)
  }
}
      ...
      _vm.fatwas.length
        ? _c(
            ...
            [
              ...
              _c(
                "tbody",
                _vm._l(_vm.fatwas, function(fatwa) {
                  return _c(
                    "tr",
                    { key: fatwa.id },
                    [
                      _vm._l(_vm.locales, function(locale, key) {
                        return _c(
                          "td",
                          [
                            _vm._l(fatwa.translations, function(translation) {
                              return translation.locale == key
                                ? _c("span", [
                                    _vm._v(
                                      "\n                            " +
                                        _vm._s(translation.question) +
                                        "\n                            "
                                    ),
                                        ...
                                        "button",
                                        {
                                          ...
                                          on: {
                                            click: function($event) {
                                              _vm.editFatwa(fatwa, translation)
                                            }
                                          }
                                        },
                                        [
        ...
        : _vm._e(),
      _vm._v(" "),
      _c("add-fatwa", { attrs: { type: _vm.type, locales: _vm.locales } }),
      _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0681925c", module.exports)
  }
}
...
(function webpackUniversalModuleDefinition(root, factory) {
	if(true)
		module.exports = factory(__webpack_require__(21), __webpack_require__(32), __webpack_require__(33));
	else if(typeof define === 'function' && define.amd)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_aa7e5940_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_component_vue__ = __webpack_require__(7);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_aa7e5940_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_component_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_trumbowyg__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_trumbowyg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_trumbowyg__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_trumbowyg_dist_ui_icons_svg__ = __webpack_require__(6);
...
var jQuery = window.jQuery || __webpack_require__(4);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  props: {
    ...
    svgPath: {
      type: [String, Boolean],
      default: __WEBPACK_IMPORTED_MODULE_1_trumbowyg_dist_ui_icons_svg___default.a
    }
  },
  data: function data() {
    return {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(30), __webpack_require__(38)(module)))
