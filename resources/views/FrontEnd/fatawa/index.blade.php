	                ...
	                <div class="panel-heading">
		                <span>
		                	@if($fatwa->scholar['photo'])
		                		<img src="{{ Storage::url($fatwa->scholar['photo']['thumbnail']) }}" name="aboutme" width="60" height="60" border="1" class="img-circle">
		                	@else
		                		<img src="{{ Storage::url('scholar.png') }}" name="aboutme" width="60" height="60" border="1" class="img-circle">
		                	@endif
		                	<a href="{{ route('scholarFatawa.show', $fatwa->scholar['slug']) }}">
		                		{{ $fatwa->scholar['name'] }}
		                	</a>
		                	<p class="pull-left blog-post-meta">{{ Date::parse($fatwa->created_at)->diffForHumans() }}</p>
		                </span>
	                </div>
