            ...
            <div class="modal-content">
              ...
              <div class="modal-header">
                ...
                <span class="form-control-static text-center">
                    <h4 class="modal-title" id="myModalLabel"> تحديث صورة مجموعة او مسلسل </h4>
                </span>
              </div>
              ...
              <div class="modal-body text-center">
              		<div style="margin-bottom: 15px;">
	              		...
	              		<img v-else src="/storage/series.jpg" width="350" height="350">
              		</div>
...
<script>
	export default {
        ...
        methods: {
            onPostCreate() {
                this.imageUploaderForm.post(`/admincp/series/${this.series_id}/photo`)
                    .then(response => eventBus.$emit('seriesAdded', response));
            },
            imageUploaderModal(serie){
                if(serie.photo){
        ...
        mounted(){
            eventBus.$on('imageUploader', serie => this.imageUploaderModal(serie));
        }
    }
</script>