          ...
          <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                    <form method="POST" action="/" @submit.prevent="onFatwaCreate" @keydown="addFatwaForm.errors.clear($event.target.name)"
                    ...
                    >
                        ...
                        <div v-if="type == 1" class="form-group">
                            ...
                            <v-select label="name" :on-search="searchScholars" :options="scholars" placeholder="اكتب اسم العالم للبحث" id="scholar_id" name="scholar_id" v-model="addFatwaForm.notFilteredScholar" ></v-select>
                        ...
                        <div class="form-group">
                            ...
                            <v-select label="name" placeholder="اكتب الاسم للبحث" :on-search="searchTags"
                             multiple :options="tags" id="tags" name="tags[]" v-model="addFatwaForm.notFilteredTags" ></v-select>
...
<script>
	...
	export default {
        ...
        watch: {
            "addFatwaForm.notFilteredTags"(val){
            ...
            "addFatwaForm.notFilteredScholar"(val){
