              ...
              <div class="modal-body">
                    ...
                    >
                        ...
                        <div v-if="type == 1" class="form-group">
                            ...
                            <v-select label="name" :on-search="searchScholars" :options="scholars" placeholder="اكتب اسم العالم للبحث" id="scholar_id" name="scholar_id" v-model="editFatwaForm.notFilteredScholar" ></v-select>
